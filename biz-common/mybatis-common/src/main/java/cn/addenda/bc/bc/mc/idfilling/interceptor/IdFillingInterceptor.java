package cn.addenda.bc.bc.mc.idfilling.interceptor;

import cn.addenda.bc.bc.jc.util.AnnotationUtils;
import cn.addenda.bc.bc.mc.idfilling.IdFillingException;
import cn.addenda.bc.bc.mc.idfilling.annotation.IdScope;
import cn.addenda.bc.bc.mc.idfilling.annotation.IdScopeController;
import cn.addenda.bc.bc.mc.idfilling.idgenerator.IdGenerator;
...
public class IdFillingInterceptor implements Interceptor {
    ...
    private IdScope extractIdScopeFromObject(Object object) {
        ...
        return PARAMETER_ID_SCOPE_MAP.computeIfAbsent
                (className, s -> AnnotationUtils.extractAnnotationFromClass(aClass, IdScope.class));
    }
