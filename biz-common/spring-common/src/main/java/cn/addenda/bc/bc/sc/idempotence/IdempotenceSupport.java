            ...
            public Object apply(StorageCenter storageCenter, ConsumeStatus consumeStatus) throws Throwable {
                if (consumeStatus == null) {
                    ...
                    if (retry) {
                        ...
                        throw exceptionCallback(storageCenter, param, scenario, arguments, ConsumeStage.WAITING_TIMEOUT, msg, new ServiceException(msg));
                    }
                }
    ...
    private Object repeatConsume(StorageCenter storageCenter, IdempotenceParamWrapper param, IdempotenceAttr attr, Object[] arguments) throws Throwable {
        ...
        switch (scenario) {
            case MQ:
                ...
                throw exceptionCallback(storageCenter, param, attr.getScenario(), arguments, ConsumeStage.REPEAT_CONSUME, msg1, new ServiceException(msg1));
            case REQUEST:
                ...
                properties.put("expectCostStr", attr.getExpectCost() + " " + TimeUnitUtils.convertTimeUnit(attr.getTimeUnit()));
                properties.put("timeout", attr.getTtl());
                properties.put("timeoutStr", attr.getTtl() + " " + TimeUnitUtils.convertTimeUnit(attr.getTimeUnit()));
