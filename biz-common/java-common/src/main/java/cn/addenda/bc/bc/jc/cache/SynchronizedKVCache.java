...
public class SynchronizedKVCache<K, V> extends KVCacheWrapper<K, V> {
    ...
    protected SynchronizedKVCache(KVCache<K, V> kvCacheDelegate) {
        super(kvCacheDelegate);
    }

    public static <KK, VV> SynchronizedKVCache synchronize(KVCache<KK, VV> kvkvCache) {
        return new SynchronizedKVCache(kvkvCache);
    }
