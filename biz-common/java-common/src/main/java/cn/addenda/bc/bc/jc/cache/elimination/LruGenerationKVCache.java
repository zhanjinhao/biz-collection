...
public class LruGenerationKVCache<K, V> extends LruKVCache<K, V> {
    ...
    public LruGenerationKVCache(long newCapacity, long oldCapacity, int threshold, KVCache<K, V> kvCacheDelegate) {
    ...
    public LruGenerationKVCache(long newCapacity, long oldCapacity, int threshold, LruDeque<K> lruDeque, KVCache<K, V> kvCacheDelegate) {
