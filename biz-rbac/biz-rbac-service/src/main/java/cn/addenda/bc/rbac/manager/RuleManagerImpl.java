...
import cn.addenda.bc.rbac.mapper.RuleMapper;
...
public class RuleManagerImpl implements RuleManager {
    ...
    public Rule queryBySqc(Long sqc) {
        return redisCacheHelper.queryWithPpf(RedisKeyConst.RULE_SQC_KEY,
    ...
    public Rule queryByRuleCode(String ruleCode) {
        return redisCacheHelper.queryWithPpf(RedisKeyConst.RULE_RULECODE_KEY,
