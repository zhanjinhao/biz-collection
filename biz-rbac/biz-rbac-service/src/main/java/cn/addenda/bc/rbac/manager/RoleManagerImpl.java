...
import cn.addenda.bc.rbac.mapper.RoleMapper;
...
public class RoleManagerImpl implements RoleManager {
    ...
    public Role queryByRoleCode(String roleCode) {
        return redisCacheHelper.queryWithPpf(RedisKeyConst.ROLE_ROLECODE_KEY,
    ...
    public Role queryBySqc(Long sqc) {
        return redisCacheHelper.queryWithPpf(RedisKeyConst.ROLE_SQC_KEY,
